...
if ((EF>=1)and(EF<=3)){
if (EF==1){drawText(0, 48, ward1, sizeof(ward1),WHITE);}
if (EF==2){drawText(0, 48, ward4, sizeof(ward4),WHITE);}
if (EF==3){drawText(0, 48, ward5, sizeof(ward5),WHITE);}

drawText(24, 48, atk, sizeof(atk),WHITE);

drawText(16, 56, ward2, sizeof(ward2),WHITE);
...
drawText(32, 56, yokeru, sizeof(yokeru),WHITE);
}
...
if (ANT!=0){drawText(0, 48, ward3, sizeof(ward3),WHITE);
  }else{
    if (DR[1]+DR[0]+2!=12){
    if ((DR[1]+DR[0]+2<AP)){drawText(0, 48, bad, sizeof(bad),WHITE);seiko=0;}
    if ((DR[1]+DR[0]+2>=AP)){drawText(0, 48, good, sizeof(good),WHITE);seiko=1;}
    }else{drawText(0, 48, sugoi, sizeof(sugoi),WHITE);seiko=1;}
  }
}
if (EF==25){//敵倒す
  drawText(0, 48, taosu, sizeof(taosu),WHITE);
  arduboy.fillRect((8-ANT)*8,48,64-(8-ANT)*8,8,0);
  AY_T=(8-ANT)*4;
  } 
  
if (EF==26){//敵現る
  drawText(0, 48, deru, sizeof(deru),WHITE);
  arduboy.fillRect((8-ANT)*8,48,64-(8-ANT)*8,8,0);
  AY_T=(ANT)*4;
  } 
...
if (Mty==0){drawText(0, 16, M_SA, sizeof(M_SA),BLACK);
}else if (Mty==1){drawText(0, 16, M_H, sizeof(M_H),BLACK);
}else if (Mty==3){drawText(0, 16, M_W, sizeof(M_W),BLACK);
}else if (Mty==2){drawText(0, 16, M_D, sizeof(M_D),BLACK);
}else if (Mty==4){drawText(0, 16, M_F, sizeof(M_F),BLACK);
}else if (Mty==5){drawText(0, 16, M_SU, sizeof(M_SU),BLACK);
}else if (Mty==6){drawText(0, 16, M_SI, sizeof(M_SI),BLACK);
}else if (NPC==5){drawText(0, 16, NPC_W_W, sizeof(NPC_W_W),BLACK);
}else if (NPC==6){drawText(0, 16, NPC_S_W, sizeof(NPC_S_W),BLACK);
}
...
if ((BF==20)or(BF==21)){
  arduboy.fillRect(0,48,64,16,0);
  if (BF==20){drawText(0, 48, BIN1, sizeof(BIN1),WHITE); }
  
  if (BF==21){drawText(0, 48, BIN2, sizeof(BIN2),WHITE); 
...
if ((BF==30)or(BF==31)or(BF==32)){
  arduboy.fillRect(0,48,88,16,0);
  if (BF==30){drawText(0, 48, NPC_W_W1, sizeof(NPC_W_W1),WHITE); }
  if (BF==31){drawText(0, 48, NPC_W_W2, sizeof(NPC_W_W2),WHITE);
              drawText(8, 56, NPC_W_W3, sizeof(NPC_W_W3),WHITE);
              drawText(0+SEL*24, 56, Migi, sizeof(Migi),WHITE);}
  if (BF==32){drawText(0, 48, NPC_W_W4, sizeof(NPC_W_W4),WHITE); }
...
if ((BF==40)or(BF==41)or(BF==42)){
  ...
  if (BF==40){drawText(0, 48, NPC_S_W1, sizeof(NPC_S_W1),WHITE); }
  if (BF==41){arduboy.fillRect(0,48,120,16,0);drawText(0, 48, NPC_S_W4, sizeof(NPC_S_W4),WHITE);
                                              drawText(24, 56, NPC_S_W5, sizeof(NPC_S_W5),WHITE);
                                              arduboy.setCursor(8,56);
                                              arduboy.print("MP");
                                              drawText(0+SEL*56, 56, Migi, sizeof(Migi),WHITE);}
  if (BF==42){drawText(0, 48, NPC_S_W3, sizeof(NPC_S_W3),WHITE); }
...
Sprites::drawExternalMask(98, 11, ED_F,ED_F_M, 0, 0);
  arduboy.fillRect(0,48,72,16,0);
drawText(0, 48, ED_W, sizeof(ED_W),WHITE);
arduboy.setCursor(8,56);
